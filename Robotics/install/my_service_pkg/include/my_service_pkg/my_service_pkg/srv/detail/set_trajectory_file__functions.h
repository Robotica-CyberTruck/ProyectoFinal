...
#ifndef MY_SERVICE_PKG__SRV__DETAIL__SET_TRAJECTORY_FILE__FUNCTIONS_H_
#define MY_SERVICE_PKG__SRV__DETAIL__SET_TRAJECTORY_FILE__FUNCTIONS_H_
...
#include "my_service_pkg/msg/rosidl_generator_c__visibility_control.h"

#include "my_service_pkg/srv/detail/set_trajectory_file__struct.h"

/// Initialize srv/SetTrajectoryFile message.
/**
...
/// Create srv/SetTrajectoryFile message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_service_pkg__srv__SetTrajectoryFile_Request__init().
...
/// Destroy srv/SetTrajectoryFile message.
/**
 * It calls
 * my_service_pkg__srv__SetTrajectoryFile_Request__fini()
...
/// Check for srv/SetTrajectoryFile message equality.
/**
...
/// Copy a srv/SetTrajectoryFile message.
/**
...
/// Initialize array of srv/SetTrajectoryFile messages.
/**
...
/// Finalize array of srv/SetTrajectoryFile messages.
/**
 * It calls
 * my_service_pkg__srv__SetTrajectoryFile_Request__fini()
...
/// Create array of srv/SetTrajectoryFile messages.
/**
 * It allocates the memory for the array and calls
 * my_service_pkg__srv__SetTrajectoryFile_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetTrajectoryFile messages.
/**
 * It calls
 * my_service_pkg__srv__SetTrajectoryFile_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetTrajectoryFile message array equality.
/**
...
/// Copy an array of srv/SetTrajectoryFile messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_service_pkg__srv__SetTrajectoryFile_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_service_pkg
...
/**
 * It calls
 * my_service_pkg__srv__SetTrajectoryFile_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_service_pkg
...
/**
 * It allocates the memory for the array and calls
 * my_service_pkg__srv__SetTrajectoryFile_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_service_pkg
...
/**
 * It calls
 * my_service_pkg__srv__SetTrajectoryFile_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MY_SERVICE_PKG__SRV__DETAIL__SET_TRAJECTORY_FILE__FUNCTIONS_H_
